...
const exports: any = {}; vm.runInNewContext(js, { exports, signal, computed, clearTimeout, HostListener: () => () => undefined, customerMessageIsReadOnly, originalCustomerMessage, salesSplitBlockReason, isCreditNote, ...availability });
