...
export const PAYMENT_TERMS: { value: PaymentTerms; label: string; instalments: Instalment[] }[] = [
  ...
  { value: 'THIRD_TWO_THIRDS_SHIPPED', label: '1/3 bij bestelling, 2/3 bij vertrek', instalments: [
    { label: '1/3 bij bestelling', share: 1 / 3, due: 'ORDERED' },
    { label: '2/3 bij vertrek', share: 2 / 3, due: 'SHIPPED' } ] },
  { value: 'THIRD_TWO_THIRDS_ARRIVED', label: '1/3 bij bestelling, 2/3 bij aankomst', instalments: [
    { label: '1/3 bij bestelling', share: 1 / 3, due: 'ORDERED' },
    { label: '2/3 bij aankomst', share: 2 / 3, due: 'ARRIVED' } ] },
  ...
  { value: 'HALF_HALF_ARRIVED', label: '50% bij bestelling, 50% bij aankomst', instalments: [
    { label: '50% bij bestelling', share: 0.5, due: 'ORDERED' },
    { label: '50% bij aankomst', share: 0.5, due: 'ARRIVED' } ] },
  ...
  { value: 'DEPOSIT_30_70_ARRIVED', label: '30% bij bestelling, 70% bij aankomst', instalments: [
    { label: '30% bij bestelling', share: 0.3, due: 'ORDERED' },
    { label: '70% bij aankomst', share: 0.7, due: 'ARRIVED' } ] },
...
export interface PurchaseOrder {
  ...
  /** A plan of one's own under CUSTOM: percentages at ordering, departure and arrival. */
  payPctOrdered?: number | null;
  payPctShipped?: number | null;
  payPctArrived?: number | null;
